...
public class ConfigurationSettingsDialog {
    ...
    public boolean open() {
        ...
        String defaultLogDir = System.getProperty("user.home") + "/.capoeira/screen_captures";
        ...
        btnAppear.addListener(SWT.Selection, e -> {
            ...
            String fn = appFontName[0].isBlank() ? br.com.capoeirassh.ssh.storage.AppearanceSettings.getFontName() : appFontName[0];
